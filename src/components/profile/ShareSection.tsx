  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap gap-2">
        <Button variant="outline" size="sm" onClick={copyLink} className="gap-1.5 rounded-lg text-xs h-9">
          <Link2 className="w-3.5 h-3.5" /> লিংক কপি
        </Button>
        <Button variant="outline" size="sm" onClick={shareToFacebook} className="gap-1.5 rounded-lg text-xs h-9">
          <Facebook className="w-3.5 h-3.5" /> ফেসবুক
        </Button>
        <Button variant="outline" size="sm" onClick={shareToWhatsApp} className="gap-1.5 rounded-lg text-xs h-9">
          <MessageCircle className="w-3.5 h-3.5" /> হোয়াটসঅ্যাপ
        </Button>
        <Button variant="outline" size="sm" onClick={nativeShare} className="gap-1.5 rounded-lg text-xs h-9">
