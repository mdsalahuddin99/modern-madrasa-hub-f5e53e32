    ...
    <div className="sticky bottom-0 z-40 bg-background/95 backdrop-blur-md border-t border-border/40 p-4 -mx-4 md:-mx-6 mt-8 shadow-[0_-4px_10px_rgba(0,0,0,0.02)]">
      <div className="flex gap-3">
        <Button
          ...
          className="flex-1 h-13 rounded-2xl shimmer-btn text-base font-bold gap-2"
        >
          {isSubmitting ? (
            "আপডেট হচ্ছে..."
          ) : (
        ...
        <Button
          ...
          disabled={isSubmitting || isLoading}
          className="h-13 px-6 rounded-2xl text-base font-bold gap-2 border-primary/20 hover:bg-primary/5"
        >
