...
const NOTIF_KEY = "qawmi_admin_notifications";
const LAST_COUNTS_KEY = "qawmi_admin_last_counts";
...
const getLastCounts = () => {
  try { return JSON.parse(localStorage.getItem(LAST_COUNTS_KEY) || "{}"); }
  catch { return {}; }
};

const saveLastCounts = (c: object) => {
  localStorage.setItem(LAST_COUNTS_KEY, JSON.stringify(c));
};
...
const AdminNotifications = () => {
  ...
  }, [summary.pendingApprovals, summary.pendingSubscriptions, notifications]);
