...
export default async function MadrasaAdmissionPage({ params }: Props) {
  ...
  return (
    <AdmissionPageClient 
      admissionFile={madrasa.admissionFile || undefined} 
      admissionFileType={madrasa.admissionFileType || undefined} 
    />
  );
}
