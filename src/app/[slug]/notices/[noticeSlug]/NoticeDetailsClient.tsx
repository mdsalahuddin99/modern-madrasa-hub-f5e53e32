...
export default function NoticeDetailsClient({ madrasa, notice }: { madrasa: any, notice: any }) {
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      {/* Back Button */}
      <Link href={`/${madrasa.slug}/notices`} className="inline-flex items-center gap-2 text-sm font-semibold text-muted-foreground hover:text-primary transition-colors bg-white dark:bg-card/60 px-4 py-2 rounded-xl shadow-sm border border-slate-100 dark:border-white/10 w-fit">
